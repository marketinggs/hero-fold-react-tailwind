      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">
          ...
          <div className="flex-1">
            ...
            {/* Subheading */}
            <h2 className="text-2xl md:text-3xl lg:text-4xl text-[#6747fb] font-medium mb-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-0 mb-8 border-y border-gray-200 py-4 divide-x divide-gray-200">
              ...
              <div className="flex flex-col items-center text-center p-3">
                <div className="bg-[#f8f5ff] p-3 rounded-full mb-2">
                  <Award className="h-6 w-6 text-[#6747fb]" />
                </div>
                <h3 className="text-sm font-semibold text-[#202020] mb-1">Eligibility</h3>
              ...
              <div className="flex flex-col items-center text-center p-3">
                <div className="bg-[#f8f5ff] p-3 rounded-full mb-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#6747fb]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex flex-col items-center text-center p-3">
                <div className="bg-[#f8f5ff] p-3 rounded-full mb-2">
                  <Clock className="h-6 w-6 text-[#6747fb]" />
                </div>
                <h3 className="text-sm font-semibold text-[#202020] mb-1">Pick a Slot</h3>
              ...
              <div className="flex flex-col items-center text-center p-3">
                <div className="bg-[#f8f5ff] p-3 rounded-full mb-2">
                  <CalendarDays className="h-6 w-6 text-[#6747fb]" />
                </div>
                <h3 className="text-sm font-semibold text-[#202020] mb-1">Duration</h3>
            ...
            {/* CTA Button */}
            <div className="mb-6">
              <button className="bg-[#6747fb] w-full md:w-auto text-white py-4 px-6 rounded-full text-xl font-medium transition-colors duration-300">
