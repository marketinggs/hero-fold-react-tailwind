...
const ProjectCard = ({ image, title, features, altText }: ProjectCardProps) => {
  return (
    <Card className="overflow-hidden border border-gray-200 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
  ...
  const projects = [
    {
      ...
      features: [
        "Learn to make a site to showcase your science project—and share it with classmates and teachers!",
        "Publish your poems, stories, or artwork on a blog to showcase your creativity."
      ]
    },
    {
      ...
      features: [
        "Find correct, interesting information super fast for school projects—using AI search assistants!",
        "Learn how to check if what you find is true and reliable—and build your own mini research report."
      ]
    },
    {
      ...
      features: [
        "Make your own quiz on dinosaurs, math puzzles, or superhero facts—and challenge your friends!",
        "Learn how games and quizzes make learning exciting and super fun!"
      ]
    },
    {
      ...
      features: [
        "Make awesome slides with cool pictures and facts super quickly — and talk about them with confidence!",
        "Make a travel brochure for a history lesson or a comic strip for a science topic!"
      ]
    },
    {
      ...
      features: [
        "Create a full project video—with narration and visuals—all by themselves!",
        "Turn your understanding of a topic like volcanoes, electricity, or World War II into short, engaging explainer videos with visuals and voiceover."
      ]
    },
    {
      ...
      features: [
        "Learn to confidently present ideas while mastering storytelling and public speaking.",
        "Use AI to create stories, script speeches, and practice delivery, boosting confidence and presentation skills."
      ]
    }
  ];
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-12 relative">
          ...
          {/* Progress Indicator */}
          <div className="absolute right-0 top-0 bg-purple-100 text-toi-purple font-semibold py-2 px-3 rounded-full">
            80%
          </div>
        </div>
